...
const Executive_members = () => {
  ...
  style={{
    backgroundImage: "url('https://techmatics.helixconferences.com/wp-content/uploads/2024/12/tech-3.jpg')",
...
>
      ...
      <div className="flex flex-col px-4 md:px-12 py-4 items-center justify-center mt-2 text-center">
        ...
        <p className="w-full md:w-2/3 text-sm md:text-base text-slate-600">
         Leading innovators and industry experts from around the world sharing knowledge and driving the conversation at FOODMICRO.
        </p>
      </div>
