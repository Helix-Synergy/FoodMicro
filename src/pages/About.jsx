...
const data = {
  event: {
    ...
    description: [
      <>
        The{" "}
        <Link to="https://helixconferences.com/buy-a-ticket">
          World Summit on Food Microbiome Science,
        </Link>{" "}
        organized by Helix Conferences, is a leading international forum
        dedicated to advancing microbiome research, enhancing gut and food
        health, and empowering scientists, researchers, and industry
        professionals worldwide. The summit is committed to fostering meaningful
        dialogue, multidisciplinary collaboration, and evidence-based practices
        that drive innovation in nutrition, functional foods, and microbiome
        therapeutics. Through keynote presentations, interactive workshops,
        panel discussions, and research sessions, participants will gain
        critical insights into cutting-edge microbiome research, novel food
        applications, precision nutrition strategies, and emerging global health
        priorities.
      </>,
      <>
  ...
  highlights: [
    ...
    },
    {
      ...
      description:
        "Participate in hands-on training in microbiome research techniques and food applications.",
    },
    {
      title: "Exhibition",
      description:
        "Explore innovative probiotics, functional foods, and microbiome technologies.",
    },
    {
      title: "Networking",
      description:
        "Connect with scientists, nutritionists, and industry leaders",
    },
    {
      title: "Gut & Food Health Focus",
      description:
        "Learn about WHO-aligned standards and best practices for nutrition and microbiome wellness",
    },
    {
    ...
    },
    {
      ...
      description:
        "Build partnerships and research connections across academia and industry.",
    },
    {
